...
export const WORDS = {
  elephant: {
    ...
    relations: [
      ...
      { id: 'atim', type: 'topic-neighbour', label: 'Same category' },
      { id: 'kinosew', type: 'topic-neighbour', label: 'Same category' },
    ],
    synonyms: [],
    antonyms: [],
    forms: [],
  ...
  atim: {
    ...
    relations: [
      { id: 'minos', type: 'related', label: 'Same category' },
      { id: 'mistatim', type: 'broader-neighbour', label: 'Same category' },
      { id: 'acimosis', type: 'narrower', label: 'Younger dog-related word' },
      { id: 'kinosew', type: 'topic-neighbour', label: 'Same category' },
    ],
    synonyms: [],
    antonyms: [],
  ...
  mistatim: {
    ...
    relations: [
      ...
      { id: 'minos', type: 'same-topic', label: 'Same category' },
      { id: 'kinosew', type: 'same-topic', label: 'Same category' },
  ...
  kinosew: {
    ...
    relations: [
      { id: 'atim', type: 'same-topic', label: 'Same category' },
      { id: 'minos', type: 'same-topic', label: 'Same category' },
      { id: 'mistatim', type: 'same-topic', label: 'Same category' },
      { id: 'wapos', type: 'same-topic', label: 'Same category' },
    ],
    synonyms: [],
    antonyms: [],
    forms: [],
